...
class StringHelper
{
    ...
    public static function smartCutEnd(
        $s,
        $maxLength,
        $trailer = '...',
        $utf8 = true
        ...
        while (
            ...
            preg_match($re, $s, $match, PREG_OFFSET_CAPTURE, $position)
        ) {
        ...
        for ($i = 0; $i < sizeof($lines); $i++) {
            ...
            for ($j = 0; $j < sizeof($words); $j++) {
                ...
                if (
                    ...
                    $attributes = \diCore\Helper\ArrayHelper::toAttributesString(
                        $options['tagAttrs']
                    );
    ...
    public static function extensionByMimeType($mimeType)
    {
