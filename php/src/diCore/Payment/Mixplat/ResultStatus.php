...
class ResultStatus extends SimpleContainer
{
	...
	public static $titles = [
		...
		self::NO_FUNDS => 'Недостаточно средств на счёте. Пополните баланс Вашего телефона на указанную сумму и произведите платёж повторно',
		...
		self::TIMEOUT_EXCEEDED => 'Время ожидания абонента истекло. Внимательно следуйте правилам из SMS-инструкции, которая придёт на номер, который Вы указали',
		self::OTHER_LIMITS_EXCEEDED => 'Недостаточно средств на счёте. Пополните баланс Вашего телефона на указанную сумму и произведите платёж повторно',
		self::NOT_PAID_OTHER_REASON => 'Технические проблемы оператора связи. Выберите другой способ оплаты', //'Не оплачен (по другой причине)',
