...
class ResultStatus extends SimpleContainer
{
	...
	public static $titles = [
		...
		self::NO_FUNDS => 'Недостаточно средств на счёте, либо Вы используете корпоративный тариф. Пополните баланс Вашего телефона на указанную сумму и произведите платёж повторно',
