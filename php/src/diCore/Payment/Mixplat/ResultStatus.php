...
class ResultStatus extends SimpleContainer
{
    ...
    public static $titles = [
        ...
        self::NO_FUNDS =>
            'Недостаточно средств на счёте. Пополните баланс Вашего телефона на указанную сумму и произведите платёж повторно',
        ...
        self::LIMIT_OF_PAYMENTS_PER_DAY =>
            'Лимит по количеству платежей за сутки',
        ...
        self::TIMEOUT_EXCEEDED =>
            'Время ожидания абонента истекло. Внимательно следуйте правилам из SMS-инструкции, которая придёт на номер, который Вы указали',
        self::OTHER_LIMITS_EXCEEDED =>
            'Недостаточно средств на счёте. Пополните баланс Вашего телефона на указанную сумму и произведите платёж повторно',
        self::NOT_PAID_OTHER_REASON =>
            'Технические проблемы оператора связи. Выберите другой способ оплаты', //'Не оплачен (по другой причине)',
        self::LOW_SUM_OF_PAYMENTS => 'Сумма платежа меньше допустимой',
        self::REDIRECTED_TO_PAY_PER_CLICK =>
            'Платеж перенаправлен на Pay-Per-Click',
        self::OPSOS_TIMEOUT_EXCEEDED =>
            'Превышено время ожидания статуса платежа от оператора. Платёж неуспешен',
        self::OPSOS_NOT_SUPPORTED =>
            'Платеж невозможен для Вашего оператора связи',
    ];
}
