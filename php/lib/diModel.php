...
class diModel implements \ArrayAccess
{
	...
	public function __call($method, $arguments)
	{
		...
		throw new \Exception(
			sprintf('diModel invalid method %s::%s/%s(%s)',
                get_class($this), $method, $fullMethod, print_r($arguments, 1)
            )
		);
	}
    ...
    public function rebuildPics($field)
    {
        ...
        $fieldFileOptions = Submit::prepareFileOptions($field, $this->getPicStoreSettings($field), $this);
