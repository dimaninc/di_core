...
class diNiceTableButtons
{
	...
	public static function getButton($action, $options = [])
	{
		...
		$title = is_array(diNiceTableButtons::$titles[$options["language"]][$action])
			? diNiceTableButtons::$titles[$options["language"]][$action][(int)$options["state"]]
			: diNiceTableButtons::$titles[$options["language"]][$action];
