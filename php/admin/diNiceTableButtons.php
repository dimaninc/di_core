...
class diNiceTableButtons
{
    public static $titles = [
        'en' => [
            ...
            'visible_logged_in' => [
                0 => 'Invisible for logged in',
                1 => 'Visible for logged in',
            ],
            'visible_top' => [
                0 => 'Invisible in top menu',
                1 => 'Visible in top menu',
            ],
            'visible_bottom' => [
                0 => 'Invisible in bottom menu',
                1 => 'Visible in bottom menu',
            ],
            'visible_2nd_bottom' => [
                0 => 'Invisible in 2nd bottom menu',
                1 => 'Visible in 2nd bottom menu',
            ],
            'visible_left' => [
                0 => 'Invisible in left menu',
                1 => 'Visible in left menu',
            ],
            'visible_right' => [
                0 => 'Invisible in right menu',
                1 => 'Invisible in right menu',
            ],
        ...
        'ru' => [
            ...
            'visible_logged_in' => [
                0 => 'Скрыто для залогиненных',
                1 => 'Видно для залогиненных',
            ],
            'visible_top' => [
                0 => 'Скрыто в верхнем меню',
                1 => 'Видно в верхнем меню',
            ],
            'visible_bottom' => [
                0 => 'Скрыто в нижнем меню',
                1 => 'Видно в нижнем меню',
            ],
            'visible_2nd_bottom' => [
                0 => 'Скрыто во 2м нижнем меню',
                1 => 'Видно во 2-м нижнем меню',
            ],
            'visible_left' => [
                0 => 'Скрыто в левом меню',
                1 => 'Видно в левом меню',
            ],
            'visible_right' => [
                0 => 'Скрыто в правом меню',
                1 => 'Видно в правом меню',
            ],
            ...
            'accepted' => [
                0 => 'Не принято автоматически',
                1 => 'Принято автоматически',
            ],
        ],
    ];
    ...
    public static function getButton($action, $options = [])
    {
        ...
        $titleSource =
            $options['customTitles'][$options['language']][$action] ??
    ...
    public static function getButtonHtml($tag = 'div', $attributes = [])
    {
        ...
        $attributesStr = ArrayHelper::toAttributesString(
            $attributes,
            true,
