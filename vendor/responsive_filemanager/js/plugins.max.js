! function(e, t) {
    ...
    function s(e, n, i) {
        if (i === t && 1 === e.nodeType) {
            ...
            if (i = e.getAttribute(o), "string" == typeof i) {
                try {
                    i = "true" === i ? !0 : "false" === i ? !1 : "null" === i ? null : +i + "" === i ? +i : Te.test(i) ? le.parseJSON(i) : i
                } catch (r) {}
                le.data(e, n, i)
            } else i = t
        }
    ...
    function S(e, t, n, i) {
        ...
        if (le.isArray(t)) le.each(t, function(t, o) {
            n || $t.test(e) ? i(e, o) : S(e + "[" + ("object" == typeof o ? t : "") + "]", o, n, i)
        });
    ...
    function j(e, t, n) {
        ...
        return H(c, u), le.isFunction(c.opts.start) && c.opts.start.call(e, c), le.fx.timer(le.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
    ...
    function W(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [h.overflow, h.overflowX, h.overflowY], "inline" === le.css(e, "display") && "none" === le.css(e, "float") && (le.support.inlineBlockNeedsLayout && "inline" !== N(e.nodeName) ? h.zoom = 1 : h.display = "inline-block")), n.overflow && (h.overflow = "hidden", le.support.shrinkWrapBlocks || p.always(function() {
    ...
    le.fn = le.prototype = {
        ...
        noConflict: function(t) {
            return e.$ === le && (e.$ = V), t && e.jQuery === le && (e.jQuery = G), le
        },
        isReady: !1,
        readyWait: 1,
        ...
        ready: function(e) {
            if (e === !0 ? !--le.readyWait : !le.isReady) {
                ...
                le.isReady = !0, e !== !0 && --le.readyWait > 0 || (U.resolveWith(Q, [le]), le.fn.trigger && le(Q).trigger("ready").off("ready"))
            }
        },
        ...
        parseJSON: function(t) {
            return e.JSON && e.JSON.parse ? e.JSON.parse(t) : null === t ? t : "string" == typeof t && (t = le.trim(t), t && fe.test(t.replace(ge, "@").replace(ve, "]").replace(me, ""))) ? new Function("return " + t)() : void le.error("Invalid JSON: " + t)
        },
        parseXML: function(n) {
            var i, o;
        ...
        access: function(e, n, i, o, r, s, a) {
            ...
            } else if (o !== t && (r = !0, le.isFunction(o) || (a = !0), u && (a ? (n.call(e, o), n = null) : (u = n, n = function(e, t, n) {
    ...
    le.Callbacks = function(e) {
        e = "string" == typeof e ? ke[e] || i(e) : le.extend({}, e);
        var n, o, r, s, a, l, c = [],
            u = !e.once && [],
            d = function(t) {
        ...
        return d.style.backgroundClip = "content-box", d.cloneNode(!0).style.backgroundClip = "", t.clearCloneStyle = "content-box" === d.style.backgroundClip, le(function() {
            ...
            s && (n = Q.createElement("div"), n.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", s.appendChild(n).appendChild(d), d.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", o = d.getElementsByTagName("td"), o[0].style.cssText = "padding:0;margin:0;border:0;display:none", c = 0 === o[0].offsetHeight, o[0].style.display = "", o[1].style.display = "none", t.reliableHiddenOffsets = c && 0 === o[0].offsetHeight, d.innerHTML = "", d.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", t.boxSizing = 4 === d.offsetWidth, t.doesNotIncludeMarginInBodyOffset = 1 !== s.offsetTop, e.getComputedStyle && (t.pixelPosition = "1%" !== (e.getComputedStyle(d, null) || {}).top, t.boxSizingReliable = "4px" === (e.getComputedStyle(d, null) || {
                    width: "4px"
                }).width, i = d.appendChild(Q.createElement("div")), i.style.cssText = d.style.cssText = r, i.style.marginRight = i.style.width = "0", d.style.width = "1px", t.reliableMarginRight = !parseFloat((e.getComputedStyle(i, null) || {}).marginRight)), typeof d.style.zoom !== Y && (d.innerHTML = "", d.style.cssText = r + "width:1px;padding:1px;display:inline;zoom:1", t.inlineBlockNeedsLayout = 3 === d.offsetWidth, d.style.display = "block", d.innerHTML = "<div></div>", d.firstChild.style.width = "5px", t.shrinkWrapBlocks = 3 !== d.offsetWidth, t.inlineBlockNeedsLayout && (s.style.zoom = 1)), s.removeChild(n), n = d = o = i = null)
        }), n = r = s = a = i = o = null, t
    }();
    var Te = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/,
        Ee = /([A-Z])/g;
    ...
    le.fn.extend({
        ...
        toggleClass: function(e, t) {
            var n = typeof e,
                i = "boolean" == typeof t;
            return this.each(le.isFunction(e) ? function(n) {
        ...
        val: function(e) {
            var n, i, o, r = this[0]; {
                ...
                if (r) return i = le.valHooks[r.type] || le.valHooks[r.nodeName.toLowerCase()], i && "get" in i && (n = i.get(r, "value")) !== t ? n : (n = r.value, "string" == typeof n ? n.replace(Se, "") : null == n ? "" : n)
            }
        }
    }), le.extend({
        valHooks: {
        ...
        removeAttr: function(e, t) {
            var n, i, o = 0,
                r = t && t.match(ue);
            if (r && 1 === e.nodeType)
                for (; n = r[o++];) i = le.propFix[n] || n, Me.test(n) ? !Pe && Le.test(n) ? e[le.camelCase("default-" + n)] = e[i] = !1 : e[i] = !1 : le.attr(e, n, ""), e.removeAttribute(Pe ? n : i)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        propHooks: {
            tabIndex: {
                get: function(e) {
                    ...
                    return n && n.specified ? parseInt(n.value, 10) : De.test(e.nodeName) || Ae.test(e.nodeName) && e.href ? 0 : t
                }
            }
        }
    }), Ne = {
    ...
    le.event = {
        ...
        add: function(e, n, i, o, r) {
            ...
            if (v) {
                for (i.handler && (c = i, i = c.handler, r = c.selector), i.guid || (i.guid = le.guid++), (a = v.events) || (a = v.events = {}), (d = v.handle) || (d = v.handle = function(e) {
                ...
                }, d.elem = e), n = (n || "").match(ue) || [""], l = n.length; l--;) s = ze.exec(n[l]) || [], f = g = s[1], m = (s[2] || "").split(".").sort(), u = le.event.special[f] || {}, f = (r ? u.delegateType : u.bindType) || f, u = le.event.special[f] || {}, p = le.extend({
                    type: f,
                    origType: g,
                    data: o,
                    handler: i,
                    ...
                    namespace: m.join(".")
                }, c), (h = a[f]) || (h = a[f] = [], h.delegateCount = 0, u.setup && u.setup.call(e, o, m, d) !== !1 || (e.addEventListener ? e.addEventListener(f, d, !1) : e.attachEvent && e.attachEvent("on" + f, d))), u.add && (u.add.call(e, p), p.handler.guid || (p.handler.guid = i.guid)), r ? h.splice(h.delegateCount++, 0, p) : h.push(p), le.event.global[f] = !0;
                e = null
            }
        },
            ...
            if (g && (u = g.events)) {
                for (t = (t || "").match(ue) || [""], c = t.length; c--;)
                    if (a = ze.exec(t[c]) || [], h = m = a[1], f = (a[2] || "").split(".").sort(), h) {
                        ...
                        l && !p.length && (d.teardown && d.teardown.call(e, f, g.handle) !== !1 || le.removeEvent(e, h, g.handle), delete u[h])
                    } else
        ...
        trigger: function(n, i, o, r) {
            ...
            if (l = d = o = o || Q, 3 !== o.nodeType && 8 !== o.nodeType && !je.test(f + le.event.triggered) && (f.indexOf(".") >= 0 && (m = f.split("."), f = m.shift(), m.sort()), a = f.indexOf(":") < 0 && "on" + f, n = n[le.expando] ? n : new le.Event(f, "object" == typeof n && n), n.isTrigger = !0, n.namespace = m.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = o), i = null == i ? [n] : le.makeArray(i, [n]), u = le.event.special[f] || {}, r || !u.trigger || u.trigger.apply(o, i) !== !1)) {
                ...
                if (n.type = f, !(r || n.isDefaultPrevented() || u._default && u._default.apply(o.ownerDocument, i) !== !1 || "click" === f && le.nodeName(o, "a") || !le.acceptData(o) || !a || !o[f] || le.isWindow(o))) {
                    d = o[a], d && (o[a] = null), le.event.triggered = f;
                    try {
                        o[f]()
                    } catch (g) {}
        ...
        function(e, t) {
            ...
            function d(e, t) {
                ...
                for (a = e, l = [], c = T.preFilter; a;) {
                    ...
                    for (r in T.filter) !(i = pe[r].exec(a)) || c[r] && !(i = c[r](i)) || (n = i.shift(), o.push({
                        value: n,
                        type: r,
                        matches: i
                    }), a = a.slice(n.length));
            ...
            $ = s.isXML = function(e) {
                ...
                return i !== A && 9 === i.nodeType && i.documentElement ? (A = i, M = i.documentElement, L = $(i), W.tagNameNoComments = r(function(e) {
                    ...
                    W.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), F.push("!=", re)
                    ...
                    CHILD: function(e, t, n, i, o) {
                        ...
                        return 1 === i && 0 === o ? function(e) {
                            ...
                            if (g) {
                                ...
                                } else if (y && (c = (t[j] || (t[j] = {}))[e]) && c[0] === R) p = c[1];
                                else
                                    for (;
            ...
            N = s.compile = function(e, t) {
                ...
                return r
            }, T.pseudos.nth = T.pseudos.eq, T.filters = x.prototype = T.pseudos, T.setFilters = new x, D(), s.attr = le.attr, le.find = s, le.expr = s.selectors, le.expr[":"] = le.expr.pseudos, le.unique = s.uniqueSort, le.text = s.getText, le.isXMLDoc = s.isXML, le.contains = s.contains
        }(e);
    var We = /Until$/,
    ...
    le.fn.extend({
        ...
        is: function(e) {
            return !!e && ("string" == typeof e ? qe.test(e) ? le(e, this.context).index(this[0]) >= 0 : le.filter(e, this).length > 0 : this.filter(e).length > 0)
        },
        ...
        le.fn[e] = function(n, i) {
            ...
            return We.test(e) || (i = n), i && "string" == typeof i && (o = le.filter(i, o)), o = this.length > 1 && !Ue[e] ? le.unique(o) : o, this.length > 1 && Re.test(e) && (o = o.reverse()), this.pushStack(o)
        }
    }), le.extend({
    ...
    st.optgroup = st.option, st.tbody = st.tfoot = st.colgroup = st.caption = st.thead, st.th = st.td, le.fn.extend({
        ...
        html: function(e) {
            return le.access(this, function(e) {
                ...
                if (!("string" != typeof e || et.test(e) || !le.support.htmlSerialize && Qe.test(e) || !le.support.leadingWhitespace && Ke.test(e) || st[(Ve.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Ge, "<$1></$2>");
                    try {
        ...
        domManip: function(e, n, i) {
            ...
            if (d && (c = le.buildFragment(e, this[0].ownerDocument, !1, this), o = c.firstChild, 1 === c.childNodes.length && (c = o), o)) {
                ...
                if (s)
                    for (l = a[a.length - 1].ownerDocument, le.map(a, m), u = 0; s > u; u++) r = a[u], it.test(r.type || "") && !le._data(r, "globalEval") && le.contains(l, r) && (r.src ? le.ajax({
                        url: r.src,
                        type: "GET",
                        dataType: "script",
                        async: !1,
    ...
    le.fn.extend({
        ...
        css: function(e, n, i, o) {
            var r, s, a, l = le.camelCase(n);
            return n = le.cssProps[l] || (le.cssProps[l] = x(e.style, l)), a = le.cssHooks[n] || le.cssHooks[l], a && "get" in a && (s = a.get(e, !0, i)), s === t && (s = dt(e, n, o)), "normal" === s && n in Ct && (s = Ct[n]), "" === i || i ? (r = parseFloat(s), i === !0 || le.isNumeric(r) ? r || 0 : s) : s
        },
        ...
        var o, r, s, a = i || ut(e),
            ...
            c = e.style;
        return a && ("" !== l || le.contains(e.ownerDocument, e) || (l = le.style(e, n)), yt.test(l) && gt.test(n) && (o = c.width, r = c.minWidth, s = c.maxWidth, c.minWidth = c.maxWidth = c.width = l, l = a.width, c.width = o, c.minWidth = r, c.maxWidth = s)), l
        ...
        var o, r, s, a = i || ut(e),
            l = a ? a[n] : t,
            c = e.style;
        return null == l && c && c[n] && (l = c[n]), yt.test(l) && !ft.test(n) && (o = c.left, r = e.runtimeStyle, s = r && r.left, s && (r.left = e.currentStyle.left), c.left = "fontSize" === n ? "1em" : l, l = c.pixelLeft + "px", c.left = o, s && (r.left = s)), "" === l ? "auto" : l
        ...
        le.cssHooks[t] = {
            ...
            set: function(e, n, i) {
                var o = i && ut(e);
                return T(e, n, i ? E(e, t, i, le.support.boxSizing && "border-box" === le.css(e, "boxSizing", !1, o), o) : 0)
            }
        }
        ...
        le.support.reliableMarginRight || (le.cssHooks.marginRight = {
            ...
            le.cssHooks[t] = {
                get: function(e, n) {
                    return n ? (n = dt(e, t), yt.test(n) ? le(e).position()[t] + "px" : n) : void 0
                }
            }
        })
        ...
        }, gt.test(e) || (le.cssHooks[e + t].set = T)
    });
    var Et = /%20/g,
        $t = /\[\]$/,
        Nt = /\r?\n/g,
    ...
    le.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !le(this).is(":disabled") && St.test(this.nodeName) && !_t.test(e) && (this.checked || !tt.test(e))
            }).map(function(e, t) {
                var n = le(this).val();
    ...
    Dt = zt.exec(At.toLowerCase()) || [], le.fn.load = function(e, n, i) {
        ...
        ajax: function(e, n) {
            function i(e, n, i, o) {
                var r, d, y, b, x, k = n;
                2 !== w && (w = 2, l && clearTimeout(l), u = t, a = o || "", C.readyState = e > 0 ? 4 : 0, i && (b = L(p, C, i)), e >= 200 && 300 > e || 304 === e ? (p.ifModified && (x = C.getResponseHeader("Last-Modified"), x && (le.lastModified[s] = x), x = C.getResponseHeader("etag"), x && (le.etag[s] = x)), 204 === e ? (r = !0, k = "nocontent") : 304 === e ? (r = !0, k = "notmodified") : (r = P(p, b), k = r.state, d = r.data, y = r.error, r = !y)) : (y = k, (e || !k) && (k = "error", 0 > e && (e = 0))), C.status = e, C.statusText = (n || k) + "", r ? m.resolveWith(h, [d, k, C]) : m.rejectWith(h, [C, k, y]), C.statusCode(v), v = t, c && f.trigger(r ? "ajaxSuccess" : "ajaxError", [C, p, r ? d : y]), g.fireWith(h, [C, k]), c && (f.trigger("ajaxComplete", [C, p]), --le.active || le.event.trigger("ajaxStop")))
            }
    ...
    le.ajaxSetup({
        ...
        return l || "jsonp" === n.dataTypes[0] ? (r = n.jsonpCallback = le.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, l ? n[l] = n[l].replace(Yt, "$1" + r) : n.jsonp !== !1 && (n.url += (Lt.test(n.url) ? "&" : "?") + n.jsonp + "=" + r), n.converters["script json"] = function() {
            ...
            e[r] = s, n[r] && (n.jsonpCallback = i.jsonpCallback, Xt.push(r)), a && le.isFunction(s) && s(a[0]), a = s = t
        }), "script") : void 0
    });
    var Qt, Kt, Gt = 0,
    ...
    } : F, Kt = le.ajaxSettings.xhr(), le.support.cors = !!Kt && "withCredentials" in Kt, Kt = le.support.ajax = !!Kt, Kt && le.ajaxTransport(function(n) {
            ...
            return {
                send: function(o, r) {
                    ...
                    l.send(n.hasContent && n.data || null), i = function(e, o) {
                        ...
                        d && r(a, u, d, c)
                    }, n.async ? 4 === l.readyState ? setTimeout(i) : (s = ++Gt, Vt && (Qt || (Qt = {}, le(e).unload(Vt)), Qt[s] = i), l.onreadystatechange = i) : i()
                },
                abort: function() {
                    i && i(t, !0)
                }
    ...
    le.Animation = le.extend(j, {
        ...
        run: function(e) {
            ...
            return this.pos = t = this.options.duration ? le.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : R.propHooks._default.set(this), this
        }
        ...
        var n, i, o = {
            ...
            r = this[0],
            s = r && r.ownerDocument;
        if (s) return n = s.documentElement, le.contains(n, r) ? (typeof r.getBoundingClientRect !== Y && (o = r.getBoundingClientRect()), i = q(s), {
        ...
        setOffset: function(e, t, n) {
            ...
            var o, r, s = le(e),
                ...
                d = {},
                p = {};
            u ? (p = s.position(), o = p.top, r = p.left) : (o = parseFloat(l) || 0, r = parseFloat(c) || 0), le.isFunction(t) && (t = t.call(e, n, a)), null != t.top && (d.top = t.top - a.top + o), null != t.left && (d.left = t.left - a.left + r), "using" in t ? t.using.call(e, d) : s.css(d)
        }
    }, le.fn.extend({
        position: function() {
            if (this[0]) {
    ...
    t.prototype = e.extend({}, e.fn.modal.Constructor.prototype), t.prototype.constructor = t, t.prototype.enforceFocus = function() {
        ...
        i = e(window).height(), o = e(window).width(), r = parseInt(h.$element.find(".lightbox-content").css("padding-top"), 10), s = parseInt(h.$element.find(".lightbox-content").css("padding-bottom"), 10), a = parseInt(h.$element.find(".lightbox-content").css("padding-left"), 10), l = parseInt(h.$element.find(".lightbox-content").css("padding-right"), 10), c = h.$element.find(".lightbox-content").find("img:first"), u = new Image, u.onload = function() {
            ...
            }), h.$element.find(".lightbox-content").css({
                width: u.width,
                height: u.height
            }), n.fire()
        }, u.src = c.attr("src")
    ...
    e.fn.lightbox = function(n) {
        ...
        var n = e(this),
            i = n.attr("href"),
            o = e(n.attr("data-target") || i && i.replace(/.*(?=#[^\s]+$)/, "")),
            r = o.data("lightbox") ? "toggle" : e.extend({
                remote: !/#/.test(i) && i
            }, o.data(), n.data());
    ...
    function(e, t) {
        ...
        var s = null,
            ...
            h = {
                ...
                position: function(e, t, n) {
                    ...
                    i = "maintain" === t && "maintain" === n ? e.$menu.position() : {
                        top: n,
                        left: t
                    };
            ...
            v = {
                ...
                hide: function(n, i) {
                    ...
                    if (n || (n = o.data("contextMenu") || {}), i || !n.events || n.events.hide.call(o, n) !== !1) {
                        ...
                        s = null, n.$menu.find(".hover").trigger("contextmenu:blur"), n.$selected = null, e(document).off(".contextMenuAutoHide").off("keydown.contextMenu"), n.$menu && n.$menu[n.animation.hide](n.animation.duration, function() {
                            n.build && (n.$menu.remove(), e.each(n, function(e, i) {
                                switch (e) {
                                    case "ns":
                                    case "selector":
                                    case "build":
                ...
                create: function(i, o) {
                    o === t && (o = i), i.$menu = e('<ul class="context-menu-list"></ul>').addClass(i.className || "").data({
                        ...
                        else if (r.type && p[r.type]) p[r.type].call(s, r, i, o), e.each([i, o], function(n, i) {
                ...
                layer: function(t, n) {
                    ...
                    return e.support.fixedPosition || i.css({
                        position: "absolute",
        ...
        e.fn.contextMenu = function(n) {
            ...
            else if (n.x && n.y) this.first().trigger(e.Event("contextmenu", {
                pageX: n.x,
                pageY: n.y
            }));
            else if ("hide" === n) {
            ...
            } else "destroy" === n ? e.contextMenu("destroy", {
                context: this
            }) : e.isPlainObject(n) ? (n.context = this, e.contextMenu("create", n)) : n ? this.removeClass("context-menu-disabled") : n || this.addClass("context-menu-disabled");
            return this
        }, e.contextMenu = function(n, i) {
            "string" != typeof n && (i = n, n = "create"), "string" == typeof i ? i = {
                selector: i
            } : i === t && (i = {});
                ...
                case "destroy":
                    ...
                    if (l) {
                        ...
                        e.each(d, function(t, n) {
                            ...
                            p = e(".context-menu-list").filter(":visible"), p.length && p.data().contextMenuRoot.$trigger.is(e(n.context).find(n.selector)) && p.trigger("contextmenu:hide", {
                                force: !0
                            });
                            try {
                        ...
                        if (u[o.selector]) {
                            p = e(".context-menu-list").filter(":visible"), p.length && p.data().contextMenuRoot.$trigger.is(o.selector) && p.trigger("contextmenu:hide", {
                                force: !0
                            });
                            try {
...
var bootbox = window.bootbox || function(e, t) {
        ...
        d.setLocale = function(e) {
            ...
            function c(e) {
                var t = null;
                "function" == typeof o.onEscape && (t = o.onEscape()), t !== !1 && k.modal("hide")
            }
            var u = "",
                d = [];
...
window.bootbox = bootbox,
            ...
            return u(n, e), n.prototype.Emitter = t, n.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], n.prototype.defaultOptions = {
                ...
                m = o(this.options.method, e), w = o(this.options.url, e), C.open(m, w, !0), C.withCredentials = !!this.options.withCredentials, y = null, s = function(n) {
                    ...
                    return function(i) {
                        ...
                        if (null != i)
                            for (r = 100 * i.loaded / i.total, s = 0, c = e.length; c > s; s++) t = e[s], t.upload = {
                                progress: r,
                                total: i.total,
                                bytesSent: i.loaded
                            };
    ...
    function(e) {
        ...
        function n(t, n) {
            function _(t) {
                if (!(ce() || e(t.target).closest(n.excludedElements, qe).length > 0)) {
                    var i, o = t.originalEvent ? t.originalEvent : t,
                        r = T ? o.touches[0] : o;
                    return Ue = w, T ? Xe = o.touches.length : t.preventDefault(), Fe = 0, Oe = null, Re = null, Ie = 0, He = 0, je = 0, ze = 1, We = 0, Ye = fe(), Be = ve(), ae(), !T || Xe === n.fingers || n.fingers === y || B() ? (de(0, r), Qe = $e(), 2 == Xe && (de(1, o.touches[1]), He = je = we(Ye[0].start, Ye[1].start)), (n.swipeStatus || n.pinchStatus) && (i = F(o, Ue))) : i = !1, i === !1 ? (Ue = k, F(o, Ue), i) : (n.hold && (et = setTimeout(e.proxy(function() {
                        qe.trigger("hold", [o.target]), n.hold && (i = n.hold.call(qe, o, o.target))
                    ...
                    if (Ke = $e(), T && (Xe = t.touches.length), n.hold && clearTimeout(et), Ue = x, 2 == Xe && (0 == He ? (de(1, t.touches[1]), He = je = we(Ye[0].start, Ye[1].start)) : (pe(t.touches[1]), je = we(Ye[0].end, Ye[1].end), Re = Ce(Ye[0].end, Ye[1].end)), ze = xe(He, je), We = Math.abs(He - je)), Xe === n.fingers || n.fingers === y || !T || B()) {
                        if (Oe = Ee(r.start, r.end), W(e, Oe), Fe = ke(r.start, r.end), Ie = be(), me(Oe, Fe), (n.swipeStatus || n.pinchStatus) && (i = F(t, Ue)), !n.triggerOnTouchEnd || n.triggerOnTouchLeave) {
                            ...
                            if (n.triggerOnTouchLeave) {
                                var a = Ne(this);
                                s = _e(r.end, a)
                            }!n.triggerOnTouchEnd && s ? Ue = P(x) : n.triggerOnTouchLeave && !s && (Ue = P(C)), (Ue == k || Ue == C) && F(t, Ue)
                        }
                    } else Ue = k, F(t, Ue);
                    i === !1 && (Ue = k, F(t, Ue))
                }
            ...
            function A() {
                Xe = 0, Ke = 0, Qe = 0, He = 0, je = 0, ze = 1, ae(), ue(!1)
            }
            ...
            function L() {
                qe.unbind(De, _), qe.unbind(Pe, A), qe.unbind(Ae, S), qe.unbind(Me, D), Le && qe.unbind(Le, M), ue(!1)
            }
            ...
            function O(t, c, u) {
                ...
                return u == h ? (c === k || c === C) && (clearTimeout(Ze), clearTimeout(et), V() && !ee() ? (Je = $e(), Ze = setTimeout(e.proxy(function() {
                    Je = null, qe.trigger("tap", [t.target]), n.tap && (g = n.tap.call(qe, t, t.target))
            ...
            function se() {
                Ge = $e(), Ve = event.touches.length + 1
            }
            ...
            function ue(e) {
                e === !0 ? (qe.bind(Ae, S), qe.bind(Me, D), Le && qe.bind(Le, M)) : (qe.unbind(Ae, S, !1), qe.unbind(Me, D, !1), Le && qe.unbind(Le, M, !1)), qe.data(N + "_intouch", e === !0)
            }
            ...
            var Se = T || $ || !n.fallbackToMouseEvents,
                ...
                et = null;
            try {
                qe.bind(De, _), qe.bind(Pe, A)
            } catch (tt) {
                e.error("events not supported " + De + "," + Pe + " on jQuery.swipe")
            }
            this.enable = function() {
                return qe.bind(De, _), qe.bind(Pe, A), qe
            }, this.disable = function() {
                return L(), qe
            }, this.destroy = function() {
                L(), qe.data(N, null), qe = null
    ...
    n.prototype = {
        ...
        appendModal: function(n) {
            ...
            n.$element.on("show.modalmanager", t(function(t) {
                ...
                n.options.replace ? i.replace(o) : o()
                ...
                if (i.backdrop(n), n.$element.parent().length)
                    if (n.$backdrop) {
                        ...
                        o && n.$element[0].offsetWidth, e.support.transition && n.$element.hasClass("fade") ? n.$backdrop.one(e.support.transition.end, function() {
                            n.destroy()
                        }) : n.destroy()
                    } else n.destroy();
        ...
        createContainer: function(n) {
            var o;
            return o = e('<div class="modal-scrollable">').css("z-index", i("modal", this.getOpenModals().length)).appendTo(this.$element), n && "static" != n.options.backdrop ? o.on("click.modal", t(function(e) {
                n.hide()
            })) : n && o.on("click.modal", t(function(e) {
                n.attention()
            })), o
        },
    ...
    function(e, t) {
        ...
        var n, i, o = e,
            ...
            Y = function(e) {
                var t, n, i;
                return e = ie(e), e && !ce(e) ? "ready" === e.type && P.overdue === !0 ? Ae.emit({
                    type: "error",
                    name: "flash-overdue"
                }) : (t = C({}, e), le.call(this, t), "copy" === e.type && (i = me(I), n = i.data, H = i.formatMap), n) : void 0
            },
            Q = function() {
                if ("boolean" != typeof P.ready && (P.ready = !1), !Ae.isFlashUnusable() && null === P.bridge) {
                    ...
                    "number" == typeof e && e >= 0 && a(function() {
                        "boolean" != typeof P.deactivated && (P.deactivated = !0), P.deactivated === !0 && Ae.emit({
                            type: "error",
            ...
            K = function() {
                Ae.clearData(), Ae.blur(), Ae.emit("destroy"), fe(), Ae.off()
            },
            G = function(e, t) {
                var n;
            ...
            Z = function(e) {
                if (e && 1 === e.nodeType) {
                    n && (ke(n, z.activeClass), n !== e && ke(n, z.hoverClass)), n = e, Ce(e, z.hoverClass);
            ...
            ie = function(e) {
                ...
                if ("string" == typeof e && e ? (t = e, e = {}) : "object" == typeof e && e && "string" == typeof e.type && e.type && (t = e.type), t) {
                    ...
                    }), "aftercopy" === e.type && (e = ge(e, H)), e.target && !e.relatedTarget && (e.relatedTarget = oe(e.target)), e = re(e)
                }
            },
            oe = function(e) {
            ...
            ce = function(e) {
                ...
                switch (e.type) {
                    ...
                    case "aftercopy":
                        ...
                        break;
                    case "_mouseover":
                        Ae.focus(t), z.bubbleEvents === !0 && o && (t && t !== e.relatedTarget && !N(e.relatedTarget, t) && ue(C({}, e, {
                            type: "mouseenter",
                            bubbles: !1,
                            cancelable: !1
                        })), ue(C({}, e, {
                        ...
                        break;
                    case "_mouseout":
                        Ae.blur(), z.bubbleEvents === !0 && o && (t && t !== e.relatedTarget && !N(e.relatedTarget, t) && ue(C({}, e, {
                            type: "mouseleave",
                            bubbles: !1,
                            cancelable: !1
                        })), ue(C({}, e, {
                        ...
                        break;
                    case "_mousedown":
                        Ce(t, z.activeClass), z.bubbleEvents === !0 && o && ue(C({}, e, {
                            type: e.type.slice(1)
                        }));
                        break;
                    case "_mouseup":
                        ke(t, z.activeClass), z.bubbleEvents === !0 && o && ue(C({}, e, {
                            type: e.type.slice(1)
                        }));
                        break;
                    case "_click":
                        i = null, z.bubbleEvents === !0 && o && ue(C({}, e, {
                            type: e.type.slice(1)
                        }));
                        break;
                    case "_mousemove":
                        z.bubbleEvents === !0 && o && ue(C({}, e, {
                            type: e.type.slice(1)
                        }))
                }
            ...
            $e = function(e) {
                ...
                if (e.getBoundingClientRect) {
                    ...
                    "pageXOffset" in o && "pageYOffset" in o ? (n = o.pageXOffset, i = o.pageYOffset) : (s = Ee(), n = f(r.documentElement.scrollLeft / s), i = f(r.documentElement.scrollTop / s));
        ...
        var Ie = function(e) {
            ...
            Re = function(e) {
                ...
                for (var t = 0; t < e.length; t++)
                    if (y.call(e, t) && e[t] && 1 === e[t].nodeType) {
                        e[t].zcClippingId ? -1 === Fe[e[t].zcClippingId].indexOf(this.id) && Fe[e[t].zcClippingId].push(this.id) : (e[t].zcClippingId = "zcClippingId_" + Pe++, Fe[e[t].zcClippingId] = [this.id], z.autoActivate === !0 && Ke(e[t]));
            ...
            Ue = function() {
                this.unclip(), this.off(), delete Le[this.id]
            },
            Xe = function(e) {
            ...
            Ke = function(e) {
                if (e && 1 === e.nodeType) {
                    ...
                    e.addEventListener("mouseover", n, !1), e.addEventListener("mouseout", t, !1), e.addEventListener("mouseenter", t, !1), e.addEventListener("mouseleave", t, !1), e.addEventListener("mousemove", t, !1), Oe[e.zcClippingId] = {
                        mouseover: n,
                        mouseout: t,
                        mouseenter: t,
                        mouseleave: t,
            ...
            plugin: {
                ...
                call: function(e, t, n) {
                    ...
                    if (o && e.element[0].parentNode && 11 !== e.element[0].parentNode.nodeType)
                        for (i = 0; i < o.length; i++) e.options[o[i][0]] && o[i][1].apply(e.element, n)
                }
            },
        ...
        e.widget("ui.draggable", e.ui.mouse, {
            ...
            drag: function(t, n) {
                ...
                for (d = h.snapElements.length - 1; d >= 0; d--) a = h.snapElements[d].left, l = a + h.snapElements[d].width, c = h.snapElements[d].top, u = c + h.snapElements[d].height, a - m > v || g > l + m || c - m > b || y > u + m || !e.contains(h.snapElements[d].item.ownerDocument, h.snapElements[d].item) ? (h.snapElements[d].snapping && h.options.snap.release && h.options.snap.release.call(h.element, t, e.extend(h._uiHash(), {
                    ...
                    }).left - h.margins.left)), !h.snapElements[d].snapping && (i || o || r || s || p) && h.options.snap.snap && h.options.snap.snap.call(h.element, t, e.extend(h._uiHash(), {
                    snapItem: h.snapElements[d].item
                })), h.snapElements[d].snapping = i || o || r || s || p)
            }
