...
function diCalendar(cfg) {
    ...
    this.get_e_ar = function (date) {
        ...
        if (ar && ar.e)
            eval(
                "_add_event(ar.e, 'keyup', function() {" +
                    this.instance_name +
                    '.init();});'
            );
    ...
    this.set_date = function (date, idx) {
      ...
      */
            ...
            if (this.has_time_fields(idx))
                date +=
                    ' ' + this.e_ar[idx].th.value + ':' + this.e_ar[idx].tm.value;
    ...
    this.get_month_html = function (m, y) {
        ...
        var m_finish = new Date(
            y,
            m - 1,
            days_in_mon_ar[is_leap][m - 1],
            12,
            0,
            0,
            0
        ...
        for (var i = 1; i <= weeks_to_show; i++) {
            ...
            for (var j = 1; j <= 7; j++) {
                ...
                day_id_attr = big_yday
                    ? ' id="' + this.id + '_' + big_yday + '"'
                    : '';
    ...
    this.get_date_str = function (date, output_type) {
        ...
        if (output_type == 'input')
            return (
                d +
                ' ' +
                dicalendar_lng_ar[this.cfg.language].month_titles[m] +
                ' ' +
                y
            );
    ...
    this.get_wd_title = function (wd) {
        if (
            typeof dicalendar_lng_ar[this.cfg.language].wd_titles[wd - 1] ==
            'undefined'
        )
