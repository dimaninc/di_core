var diAdminForm = function (table, id, auto_save_timeout) {
    ...
    this.initFileInputs = function () {
        $('body').on(
            ...
            function () {
                ...
                var $existingPreviewArea = $valueWrapper.find(
                    '.existing-pic-holder'
                );
                var $previewArea;
                var ext;
                ...
                if (this.files.length) {
                    if (chunk) {
                        ...
                        var $inpUploaded = $(
                            'input[name="__uploaded__{0}"]'.format(field)
                        );
                        var $inpOrigFilename = $(
                        ...
                        var resetInput = function () {
                            ...
                            try {
                                ...
                                console.log(
                                    'Unable to reset input after upload: ',
                                    e
                                );
                            }
                        };
    ...
    this.initRotateAndWaterMarkLinks = function () {
        $(
            '.existing-pic-holder a.rotate-pic, .existing-pic-holder a.watermark-pic'
        ).on('click', function () {
            var $this = $(this);
    ...
    this.color_select_onchange = function (field, freeze_input) {
        ...
        if (img && inp) {
            ...
            if (
                inp.value &&
                /^\#?([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/.test(inp.value)
            ) {
                var s = inp.value;
                if (s[0] !== '#') s = '#' + s;
