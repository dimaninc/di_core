<?php
class diMigration_20000101000004 extends diMigration
{
	public static $idx = "20000101000004";
	public static $name = "Tables (old format -> new) mail_queue";

	private $tables = array("mail_queue");
